...
public record User(
    ...
    public User addSeeds(List<Seed> seedsToAdd) {
        ...
        return new User(username, hasFinishedTutorial, new Inventory(currentSeeds, inventory.fertilizerList())); // Return a new User record with updated seeds
    }
    ...
    public User removeSeeds(List<Seed> seedsToRemove) {
        ...
        return new User(username, hasFinishedTutorial, new Inventory(currentSeeds, inventory.fertilizerList()));
    }
